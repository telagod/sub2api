...
import (
	...
	"github.com/telagod/subme/ent/schema"
...
func init() {
	...
	// apikeyDescKeyEncrypted is the schema descriptor for key_encrypted field.
	apikeyDescKeyEncrypted := apikeyFields[3].Descriptor()
	// apikey.KeyEncryptedValidator is a validator for the "key_encrypted" field. It is called by the builders before save.
	apikey.KeyEncryptedValidator = apikeyDescKeyEncrypted.Validators[0].(func(string) error)
