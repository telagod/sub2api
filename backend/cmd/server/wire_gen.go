...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	credentialCipher := repository.NewCredentialCipher(configConfig, secretEncryptor)
	apiKeyRepository := repository.NewAPIKeyRepository(client, db, credentialCipher)
	...
	openRouterCatalogService := service.ProvideOpenRouterCatalogService(configConfig, pricingRemoteClient)
	modelOverrideRepository := repository.NewModelOverrideRepository(client)
	overrideResolver := service.NewOverrideResolver(openRouterCatalogService, modelOverrideRepository)
	channelHandler := admin.NewChannelHandler(channelService, billingService, pricingService, openRouterCatalogService, overrideResolver)
	modelCatalogHandler := admin.NewModelCatalogHandler(openRouterCatalogService, modelOverrideRepository, overrideResolver)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, modelCatalogHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, paymentHandler, affiliateHandler)
