...
import (
	...
	pkgerrors "github.com/telagod/subme/internal/pkg/errors"
...
func (h *GatewayHandler) buildAPIKeyDailyUsage(c *gin.Context, userID, apiKeyID int64, days int) any {
	...
	startTime, endTime := keyDailyRange(days, c.Query("timezone"))
...
func (h *GatewayHandler) CountTokens(c *gin.Context) {
	...
	assignOpsRequestContext(c, parsedReq.Model, parsedReq.Stream)
