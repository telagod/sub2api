...
func (m *sessionWindowMockRepo) ListWithFilters(context.Context, pagination.PaginationParams, string, string, string, string, int64, string, ...map[string]string) ([]Account, *pagination.PaginationResult, error) {
	panic("unexpected")
}
...
func (m *sessionWindowMockRepo) BulkCreate(context.Context, []*Account, [][]int64) error {
	panic("unexpected")
}
