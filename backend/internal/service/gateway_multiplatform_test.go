...
func (m *mockAccountRepoForPlatform) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, status, search string, groupID int64, privacyMode string, extraFilters ...map[string]string) ([]Account, *pagination.PaginationResult, error) {
	return nil, nil, nil
}
...
func (m *mockAccountRepoForPlatform) BulkCreate(ctx context.Context, accounts []*Account, groupIDsPerAccount [][]int64) error {
	return nil
}
