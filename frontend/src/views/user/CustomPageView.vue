      ...
      <Card class="flex-1 min-h-0 overflow-hidden">
        ...
        <div v-else class="custom-embed-shell">
          <a
            ...
            class="inline-flex items-center justify-center gap-2 rounded bg-metal-raised text-foreground border border-border shadow-metal-edge hover:brightness-110 px-3 py-1.5 text-xs font-medium transition-all duration-150 custom-open-fab"
          >
...
.markdown-page-content h1 { @apply text-3xl font-bold mt-8 mb-4 pb-2 border-b border-border; }
