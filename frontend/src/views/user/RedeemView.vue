    ...
    <div class="mx-auto max-w-2xl space-y-6">
      ...
      <div class="card overflow-hidden">
        <div class="bg-foreground px-6 py-8 text-center">
          ...
          <p class="text-sm font-medium text-muted-foreground">{{ t('redeem.currentBalance') }}</p>
        ...
        <div class="p-6">
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
              ...
              <ul
                class="mt-2 list-inside list-disc space-y-1 text-sm text-muted-foreground"
              >
          ...
          <div v-else-if="history.length > 0" class="space-y-3">
            ...
            >
              ...
              <div class="text-right">
                ...
                <p
                  v-if="item.notes"
                  class="mt-1 text-xs text-muted-foreground italic max-w-[200px] truncate"
                  :title="item.notes"
                >
                  {{ item.notes }}
                </p>
