      ...
      <nav class="mx-auto flex max-w-6xl items-center justify-between">
        ...
        <div class="flex items-center gap-3">
          ...
          >
            ...
            <span class="text-xs font-medium text-foreground">{{ t('home.dashboard') }}</span>
            <svg
      ...
      <div class="mx-auto max-w-6xl">
        ...
        <div class="mb-12 flex flex-col items-center justify-between gap-12 lg:flex-row lg:gap-16">
          ...
          <div class="flex-1 text-center lg:text-left">
            <h1
              class="mb-4 text-4xl font-bold text-foreground md:text-5xl lg:text-6xl"
            >
              {{ siteName }}
            </h1>
            <p class="mb-8 text-lg text-foreground/85 md:text-xl">
              {{ siteSubtitle }}
            </p>
        ...
        <div class="mb-16 flex flex-wrap items-center justify-center gap-4">
          ...
          >
            ...
            <span class="text-sm font-medium text-foreground/85">{{ t('home.providers.claude') }}</span>
            <span
              class="rounded bg-primary-300/10 px-1.5 py-0.5 text-[10px] font-medium text-primary-200 border border-border"
          ...
          >
            ...
            <span class="text-sm font-medium text-foreground/85">GPT</span>
            <span
              class="rounded bg-primary-300/10 px-1.5 py-0.5 text-[10px] font-medium text-primary-200 border border-border"
              >{{ t('home.providers.supported') }}</span
            >
          ...
          >
            ...
            <span class="text-sm font-medium text-foreground/85">{{ t('home.providers.gemini') }}</span>
            <span
              class="rounded bg-primary-300/10 px-1.5 py-0.5 text-[10px] font-medium text-primary-200 border border-border"
              >{{ t('home.providers.supported') }}</span
            >
          ...
          >
            ...
            <span class="text-sm font-medium text-foreground/85">{{ t('home.providers.antigravity') }}</span>
            <span
              class="rounded bg-primary-300/10 px-1.5 py-0.5 text-[10px] font-medium text-primary-200 border border-border"
              >{{ t('home.providers.supported') }}</span
            >
          ...
          >
            ...
            <span class="text-sm font-medium text-foreground/85">{{ t('home.providers.more') }}</span>
            <span
              class="rounded bg-muted px-1.5 py-0.5 text-[10px] font-medium text-muted-foreground border border-border"
