...
const paymentConfig: SettingsSection = {
  ...
  fields: [
    ...
    },
    {
      ...
      label: 'admin.settings.payment.cancelRateLimitWindowMode',
      type: 'select',
      options: [
    ...
    },
    {
      ...
      label: 'admin.settings.payment.cancelRateLimitWindow',
      type: 'number',
      showWhen: (v) => !!v['payment_enabled'] && !!v['payment_cancel_rate_limit_enabled'],
    },
    {
      key: 'payment_cancel_rate_limit_unit',
      label: 'admin.settings.payment.cancelRateLimitUnit',
      type: 'select',
      options: [
    ...
    },
    {
      ...
      label: 'admin.settings.payment.cancelRateLimitMax',
      type: 'number',
      showWhen: (v) => !!v['payment_enabled'] && !!v['payment_cancel_rate_limit_enabled'],
    },
    {
