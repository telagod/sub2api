  ...
  <Card>
    ...
    <div class="px-6 py-6">
      ...
      <div v-else-if="status && !status.feature_enabled" class="flex items-center gap-4 py-4">
        <div class="flex-shrink-0 rounded-md border border-border bg-metal-raised p-3 shadow-metal-edge">
      ...
      <div v-else-if="status?.enabled" class="flex items-center justify-between">
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p v-if="status.enabled_at" class="text-sm text-muted-foreground">
