        ...
        <div class="flex flex-col gap-6 lg:flex-row lg:items-start">
          ...
          <div class="min-w-0 flex-1 space-y-5">
            <div class="space-y-3">
              ...
              <div class="space-y-1">
                <p class="truncate text-sm text-foreground/85">
                  {{ primaryEmailDisplay }}
                </p>
                <div
        ...
        >
          ...
          <div class="mt-5 grid gap-3">
            <div
              v-for="hint in sourceHints"
              :key="hint.key"
              class="flex items-start gap-3 rounded-lg border border-border bg-muted px-4 py-3 text-sm text-foreground/85"
            >
              <Icon name="link" size="sm" class="mt-0.5 text-muted-foreground" />
              <span>{{ hint.text }}</span>
            </div>
          </div>
        </section>
