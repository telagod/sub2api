    ...
    <Card>
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-foreground">{{ stats?.today_requests || 0 }}</p>
    ...
    <Card>
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-foreground">{{ formatTokens(stats?.today_tokens || 0) }}</p>
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1">
          ...
          <div class="flex items-baseline gap-2">
            <p class="text-xl font-bold text-foreground">{{ formatTokens(stats?.rpm || 0) }}</p>
    ...
    <Card>
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-foreground">{{ formatDuration(stats?.average_duration_ms || 0) }}</p>
