  ...
  <div class="relative">
    ...
    <template v-if="isAdmin">
      ...
      >
        ...
        <span
          v-else
          class="h-3 w-12 animate-pulse rounded bg-muted font-medium"
        ></span>
        <!-- Update indicator -->
            ...
            <template v-else>
              ...
              <div class="mb-4 text-center">
                <div class="inline-flex items-center gap-2">
                  ...
                  >
                  <span v-else class="text-2xl font-bold text-muted-foreground">--</span>
                  <!-- Show check mark when up to date -->
                  <span
                    v-if="!hasUpdate"
                    class="flex h-5 w-5 items-center justify-center rounded-full bg-emerald-500/10 border border-emerald-500/30"
                  >
                    <svg
              ...
              <div v-else-if="updateSuccess && needRestart" class="space-y-2">
                <div
                  class="flex items-center gap-3 rounded-md border border-emerald-500/30 bg-emerald-500/10 p-3"
                >
                  <div
                    class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-emerald-500/10 border border-emerald-500/30"
                  >
                    <svg
              ...
              <div v-else-if="hasUpdate && !isReleaseBuild" class="space-y-2">
                <a
                  ...
                  class="group flex items-center gap-3 rounded-md border border-amber-500/30 bg-amber-500/10 p-3 transition-colors hover:bg-amber-500/20"
                >
                  <div
                    class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-amber-500/10 border border-amber-500/30"
                  >
                    <Icon
                      name="download"
                      size="sm"
              ...
              <div v-else-if="hasUpdate && isReleaseBuild" class="space-y-2">
                <!-- Update info card -->
                <div
                  class="flex items-center gap-3 rounded-md border border-amber-500/30 bg-amber-500/10 p-3"
                >
                <div
                  class="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-amber-500/10 border border-amber-500/30"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  class="flex items-center justify-center gap-1 text-xs text-muted-foreground transition-colors hover:text-foreground"
                >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                class="flex items-center justify-center gap-2 py-2 text-sm text-muted-foreground transition-colors hover:text-foreground"
              >
    ...
    <span v-else-if="version" class="text-xs text-muted-foreground">
      v{{ version }}
    </span>
  </div>
</template>
