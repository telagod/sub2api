    ...
    <div v-if="user" class="space-y-4">
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="min-w-0 flex-1">
            <div class="flex items-center gap-2">
              ...
              <span v-if="user.deleted_at" class="flex-shrink-0 inline-flex items-center rounded px-1 py-px text-[10px] font-medium leading-tight bg-rose-500/10 text-rose-400 ring-1 ring-inset ring-rose-500/30">
      ...
      <div class="flex items-center gap-3">
        ...
        <button
          v-if="!hideActions"
          @click="emit('deposit')"
          class="flex items-center gap-2 rounded-md border border-border bg-card px-3 py-2 text-sm text-foreground/85 transition-colors hover:bg-accent"
        >
      ...
      <div v-if="loading" class="flex justify-center py-8">
        <svg class="h-8 w-8 animate-spin text-primary-200" fill="none" viewBox="0 0 24 24">
