<template>
  ...
  >
    <div class="space-y-4">
      ...
      <div v-if="!platform" class="flex items-start gap-3 p-4 rounded-md bg-amber-500/10 border border-amber-500/30">
        <svg class="w-5 h-5 text-amber-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
      ...
      <template v-else>
        ...
        <div class="space-y-4">
          ...
          >
            <!-- File Hint (if exists) -->
            <p v-if="file.hint" class="text-xs text-amber-400 mb-1.5 flex items-center gap-1">
