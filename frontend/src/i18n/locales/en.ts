export default {
  ...
  home: {
    ...
    // QUENCH redesign: professional landing
    quench: {
      ...
      capabilitiesDesc: 'A complete gateway pipeline — onboarding, scheduling, billing and risk control',
      features: {
        realtimeUsage: 'Real-time Usage & Alerts',
        realtimeUsageDesc: 'Request-level usage details, live QPS and error-rate monitoring with automatic alerting.',
        riskControl: 'Risk Control & Rate Limiting',
        riskControlDesc: 'Three-tier limits (RPM / concurrency / quota), IP allowlists and anomaly detection.',
        stickySession: 'Sticky Sessions',
        stickySessionDesc: 'Conversations route consistently to the same upstream account — no context drift.'
      },
      ctaTitle: 'Ready to integrate?',
      ctaDesc: 'Sign up to get a unified key. OpenAI-compatible protocol, migrate in minutes.'
    },
  ...
  nav: {
    ...
    quench: {
      ...
      settings: 'Settings',
      announcements: 'Announcements',
      searchPlaceholder: 'Search pages or jump to...',
      openCommandPalette: 'Open command palette',
      commandPalette: 'Command Palette',
      commandPalettePlaceholder: 'Search pages, features...',
  ...
  admin: {
    ...
    settings: {
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for subme end-user login',
      ...
      gatewayForwarding: {
        ...
        openaiCodexUserAgentPlaceholder: 'codex-tui/0.125.0 (Ubuntu 22.04; x86_64) xterm-256color (codex-tui; 0.125.0)',
      ...
      agreement: {
        docsHint: 'Example documents: Terms of Service, Usage Policy, Supported Regions, Service Terms.',
        addDoc: 'Add document',
        unnamedDoc: 'Untitled document',
        docTitle: 'Document title',
        docTitlePlaceholder: 'e.g. Terms of Service',
        docSlug: 'Route slug',
    ...
    // ── New Quench pages i18n keys (Route C P1~P4) ─────────────────────────
    usersQuench: {
      title: 'Users',
      desc: 'Customer domain · People-first, click row to expand User 360',
      refresh: 'Refresh',
      createBtn: '+ New User',
      searchPlaceholder: 'Email / Username / ID…',
      ...
      bulkDisable: 'Disable',
      bulkDelete: 'Delete',
      bulkDeleteTitle: 'Bulk Delete Users',
      bulkDeleteConfirm: 'Confirm deleting {n} selected user(s)? This action is irreversible.',
      bulkDeleteCancel: 'Cancel',
      bulkDeleteConfirmBtn: 'Confirm Delete',
      bulkDeletingProgress: 'Deleting… ({current}/{total})',
      noEnableTarget: 'No users to enable',
      noDisableTarget: 'No users to disable',
      bulkEnabledSuccess: 'Enabled {n} user(s)',
      bulkDisabledSuccess: 'Disabled {n} user(s)',
      bulkDeletedSuccess: 'Deleted {n} user(s)',
      colUser: 'User',
      colRole: 'Role',
      colBalance: 'Balance',
      ...
      disabled: 'Disabled',
      // ── 高级筛选字段 ──
      filterFieldRole: 'Role',
      filterFieldStatus: 'Status',
      filterFieldGroup: 'Group',
      filterFieldGroupPlaceholder: 'Group name…',
      filterFieldBalance: 'Balance',
      filterMin: 'Min',
      filterMax: 'Max',
      filterFieldCreatedAt: 'Registered',
      filterFieldLastActive: 'Last Active',
      filterFieldSubStatus: 'Subscription',
    ...
    subscriptionsQuench: {
      title: 'Subscriptions',
      desc: 'Subscription domain · Assign, extend, revoke and reset quotas',
      refresh: 'Refresh',
      assignBtn: '+ Assign',
      viewAll: 'All',
      viewActive: 'Active',
      ...
      filterGroup: 'Group',
      filterExpires: 'Expiry date',
      filterAutoRenew: 'Auto-renew',
      filterSearch: 'Search',
      searchPlaceholder: 'Email / User ID…',
      actionExtend: 'Extend / Adjust',
      actionResetQuota: 'Reset quota',
      actionRevoke: 'Revoke',
      bulkRevoke: 'Revoke',
      noBulkRevokeTarget: 'No active subscriptions to revoke',
      bulkRevokedSuccess: 'Revoked {n} subscription(s)',
      assignTitle: 'Assign Subscription',
      extendTitle: 'Extend / Adjust Subscription',
      revokeTitle: 'Revoke Subscription',
      resetQuotaTitle: 'Reset Usage Quota',
      formUser: 'User',
      formGroup: 'Plan Group',
      formDays: 'Validity Days',
      formAdjustDays: 'Adjust Days',
      searchUserPlaceholder: 'Search by email or ID…',
      noGroups: 'No subscription groups available',
      validityHint: 'Number of days the subscription will be valid (min 1)',
      adjustHint: 'Positive = extend, Negative = shorten. Adjusted expiry must be in the future.',
      adjustDaysPlaceholder: 'e.g. 30 or -7',
      extendForUser: 'Adjusting for:',
      currentExpiry: 'Current expiry',
      assign: 'Assign',
      assigning: 'Assigning…',
      assignedSuccess: 'Subscription assigned',
      adjust: 'Apply',
      adjusting: 'Applying…',
      extendedSuccess: 'Subscription adjusted',
      revoke: 'Revoke',
      revoking: 'Revoking…',
      revokedSuccess: 'Subscription revoked',
      revokeConfirm: 'Revoke subscription for {user}? This action is irreversible.',
      resetQuota: 'Reset',
      resetting: 'Resetting…',
      quotaResetSuccess: 'Usage quota reset',
      resetQuotaConfirm: 'Reset all usage quotas (daily / weekly / monthly) for {user}?',
    },
    ...
    userFormDrawer: {
      ...
      passwordGenTitle: 'Generate random password',
      ...
      rpmHint: '(0 = unlimited)',
      notesLabel: 'Notes',
      notesPlaceholder: 'Internal admin notes',
      cancelBtn: 'Cancel',
      saving: 'Saving…',
      creating: 'Creating…',
      ...
      validConcurrencyMin: 'Concurrency limit must be at least 1',
    ...
    userDetailDrawer: {
      ...
      ariaLabelUser: 'User Details - {email}',
      ariaClose: 'Close drawer',
      ...
      tabOrders: 'Orders',
      tabUsage: 'Usage',
      tabRisk: 'Risk Control',
      adjustBalance: 'Adjust Balance',
      disableAccount: 'Disable Account',
      enableAccount: 'Enable Account',
      cannotDisableSelf: 'Cannot disable your own admin account',
    ...
    userTabs: {
      ...
      keyGroup: 'Group: {name}',
      keyQuota: 'Quota: ',
      keyQuotaUnlimited: 'Unlimited',
      keyUsed: 'Used: ',
      keyCreated: 'Created: ',
      keyLastUsed: 'Last used: ',
      totalCount: '{total} total',
      totalCountPartial: '{total} total, showing first {shown}',
      noOrders: 'No orders',
      noSubscriptions: 'No subscriptions',
      subStart: 'Start: ',
      subExpires: 'Expires: ',
      subPermanent: 'Never expires',
      subDailyCost: 'Daily cost',
      subMonthlyCost: 'Monthly cost',
      subStatusActive: 'Active',
      subStatusExpired: 'Expired',
      subStatusRevoked: 'Revoked',
      noRiskLogs: 'No risk control logs',
      riskFlagged: 'Flagged',
      riskAutoBanned: 'Auto-banned',
      riskPassed: 'Passed',
      riskMode: 'Mode: ',
      ...
      infoConcurrency: 'Concurrency Limit',
      infoRpm: 'RPM Limit',
      infoRpmUnlimited: 'Unlimited',
      infoRegistered: 'Registered',
      infoLastActive: 'Last Active',
      infoNotes: 'Notes',
    ...
    accountsQuench: {
      ...
      filterStatus: 'Status',
      filterGroup: 'Group',
      filterPrivacyMode: 'Privacy Mode',
      typeApiKey: 'API Key',
      typeOAuth: 'OAuth',
      ...
      summaryError: 'Error',
      summaryRateLimited: 'Rate Limited',
      refresh: 'Refresh',
      moreTools: 'More Tools',
      viewModeLabel: 'View Mode',
      toolsSync: 'CRS Sync',
      toolsImport: 'Import Data',
      toolsExport: 'Export Data',
      toolsErrorPassthrough: 'Error Passthrough Rules',
      toolsTLSProfiles: 'TLS Fingerprint Config',
      viewMatrix: 'Health Matrix',
      viewTable: 'Table View',
      deleteTitle: 'Delete Account',
      deleteConfirmFmt: 'Confirm deleting account "{name}"?',
    ...
    accountTablePanel: {
      ...
      bulkSelectPage: 'Select page',
      bulkClear: 'Clear',
      bulkDelete: 'Bulk Delete',
      bulkResetStatus: 'Reset Status',
      bulkRefreshToken: 'Refresh Credentials',
      bulkEnableSchedule: 'Enable Scheduling',
      bulkDisableSchedule: 'Disable Scheduling',
      bulkEdit: 'Bulk Edit',
      colName: 'Name',
      colCapacity: 'Capacity',
      colStatus: 'Status',
      colGroups: 'Groups',
      colUsage: 'Usage Windows',
      colTodayStats: 'Today Stats',
      colProxy: 'Proxy',
      colPriority: 'Priority',
      colMultiplier: 'Multiplier',
      colLastUsed: 'Last Used',
      colCreatedAt: 'Created',
      scheduleEnabled: 'Scheduling enabled',
    ...
    dashboardQuench: {
      title: 'Cockpit',
      desc: 'Operations at a glance · Data refreshes every 5s',
      refresh: 'Refresh',
      live: 'Live',
      updatedAt: 'Updated {time}',
      kpiRevenue: "Today's Revenue",
      kpiMargin: "Today's Margin",
      kpiMarginNa: 'Margin needs payment data',
      kpiOrdersSub: '{n} order(s)',
      kpiRequests: "Today's Requests",
      kpiAccumRequests: 'Total {n}',
      kpiNewUsers: 'New Users',
      kpiTotalUsers: 'Total {n}',
      kpiCostToday: "Today's Cost",
      kpiCostSub: 'Account cost',
      kpiTokenToday: "Today's Tokens",
      kpiTokenAccum: 'Total {n}',
      kpiAvgResponse: 'Avg Response',
      kpiActiveUsers: '{n} active users',
      loadFailed: 'Failed to load cockpit data',
      anomalyAccountPool: 'Account Pool',
      anomalyViewMore: 'View →',
      anomalyErrors: 'Errors',
      anomalyRateLimit: 'Rate Limited',
      anomalyNormal: 'Normal',
      anomalyTotalAccounts: '{n} accounts total',
      anomalyAlerts: 'Alert Events',
      anomalyFiring: 'Firing',
      anomalyResolved: 'Resolved',
      anomalyNoAlerts: 'No active alerts',
      anomalyKeyActive: 'Active',
      anomalyKeyInactive: 'Inactive',
      anomalyTotalKeys: '{n} keys total',
    },

    pricingDesk: {
      title: 'PayGo Pricing Desk',
      desc: 'Channel price × Group multiplier → User effective price matrix',
      refresh: 'Refresh',
      simulatorBtn: 'Price Simulator',
      loadFailed: 'Load failed: ',
      noData: 'No channel pricing data',
      noDataHint: 'Configure channel pricing in the channel pricing page first',
      goConfigBtn: 'Go to Channel Pricing Config',
      colModel: 'Model',
      modelCount: '{n} models',
      ...
      simGroupLabel: 'Group',
      simGroupPlaceholder: '— Select group —',
      simCacheHit: 'Cache hit ratio',
      simResultTitle: 'Calculation Result',
      simInputCost: 'Input cost',
      simOutputCost: 'Output cost',
      simCacheCost: 'Cache read cost',
      simTotal: 'Total',
      simOfficialTotal: 'Official price total: ',
      simCheaper: '{diff} cheaper ({pct}%)',
      simDearer: '{diff} more expensive ({pct}%)',
      simNoOfficialRef: 'No official reference price available',
      simSelectHint: 'Select a model and group to see pricing',
      simInputTokens: 'Input tokens',
      simOutputTokens: 'Output tokens',
      simClose: 'Close simulator',
      syncCatalogBtn: 'Sync Catalog',
      syncCatalogTitle: 'Sync multi-provider pricing details from OpenRouter',
      syncSuccess: '{n} model(s) synced',
      officialStripLabel: 'Official',
      officialStripPerM: '/M',
      sourceChipTitle: 'Click to view multi-provider comparison',
    },

    providerVerify: {
      close: 'Close',
      loadError: 'Load failed: ',
      baselineNote: 'Baseline source: ',
      baselineBadge: 'Baseline',
      colProvider: 'Provider',
      colIn: 'Input /M',
      colOut: 'Output /M',
      colCacheRead: 'Cache Read /M',
      colCacheWrite: 'Cache Write /M',
      colUptime: 'Uptime',
      colQuant: 'Quant',
      noProviders: 'No provider data yet — sync to populate',
      noSlug: 'No model slug specified',
      syncing: 'Syncing provider prices…',
      showMore: 'Show more',
      showLess: 'Show less',
      editBtn: 'Override price',
      editDisabledTip: 'Price override will be available in P3',
      overriddenBadge: 'Overridden',
      overriddenLabel: 'overridden',
      pinnedBadge: 'Pinned',
      panelTitle: 'Edit price override',
      modeAuto: 'Auto lowest price',
      modeAutoHint: 'Deletes override, restores auto',
      modePinned: 'Pin provider',
      modeManual: 'Manual input',
      modeManualHint: 'per-MTok, leave blank = no override',
      selectProviderPlaceholder: '— select provider —',
      fieldInput: 'Input',
      fieldOutput: 'Output',
      fieldCacheRead: 'Cache Read',
      fieldCacheWrite: 'Cache Write',
      fieldPlaceholder: 'leave blank',
      noteLabel: 'Note (optional)',
      notePlaceholder: 'e.g. Negotiated rate effective 2026-Q3',
      saveBtn: 'Save',
      saving: 'Saving…',
    ...
    plansCatalog: {
      title: 'Plan Catalog',
      desc: 'Operations mirror · What you see is what you sell, card order = storefront order',
      statTotal: 'Total Plans',
      statOnSale: 'On Sale',
      statOffSale: 'Archived',
      emptyText: 'No plans yet. Click "New Plan" to get started.',
      onSale: 'On Sale',
      offSale: 'Archived',
      moveUp: 'Move Up',
      moveDown: 'Move Down',
      ...
      toggleOnTitle: 'Click to archive',
      toggleOffTitle: 'Click to publish',
    ...
    settingsRegistry: {
      ...
      fieldPasswordConfigured: 'Configured — leave blank to keep unchanged',
      tabGeneral: 'General',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: 'Welcome to the subme Console',
        description:
          '<div class="q-tour"><p>subme converges multiple upstream AI subscriptions into one unified API supply line. The console is organized by <b>business domain</b>:</p><ul><li><b>Customers</b> — users and referrals</li><li><b>Monetization</b> — plans, orders, redeem codes</li><li><b>Supply</b> — account pool, group routing, channel pricing</li><li><b>Reliability</b> — monitoring, alerts and risk control</li></ul><p class="q-tour-cta">Next: a 3-minute first-time supply setup →</p></div>',
        nextBtn: 'Start Setup',
        prevBtn: 'Skip'
      },
      domains: {
        ...
        description:
          '<div class="q-tour"><p>The sidebar is grouped by business domain instead of a flat feature list.</p><p>Daily flow: <b>Cockpit</b> for the big picture → <b>Supply</b> for capacity → <b>Customers/Monetization</b> for growth → <b>Reliability</b> as the safety net.</p></div>'
      },
      cmdk: {
        title: 'Command Palette ⌘K',
        description:
          '<div class="q-tour"><p>Press <kbd>Ctrl</kbd>+<kbd>K</kbd> (or ⌘K) on any page to open the command palette and jump anywhere by name.</p><p class="q-tour-cta">The fastest way to move around — worth the muscle memory.</p></div>'
      },
      groupManage: {
        title: 'Step 1: Groups & Routing',
        description:
          '<div class="q-tour"><p>A <b>group</b> is the core of the supply side: one group = one service line.</p><ul><li>Multiple upstream accounts per group, auto-scheduled</li><li>Independent billing multiplier, public or exclusive</li></ul><div class="q-tour-tip">Example: a high-multiplier "VIP line" and a low-multiplier "Free trial"</div><p class="q-tour-cta">Click "Groups & Routing" in the sidebar →</p></div>'
      },
      createGroup: {
        title: '➕ Create New Group',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Let\'s create your first group.</p><p style="padding: 8px 12px; background: rgba(92,168,255,.08); border-left: 3px solid #5CA8FF; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>📝 Tip:</b> Recommend creating a test group first to familiarize yourself with the process</p><p style="color: #46C98C; font-weight: 600;">👉 Click the "Create Group" button</p></div>'
      },
      groupName: {
      ...
      groupSubmit: {
        title: '✅ Save Group',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Confirm the information and click create to save the group.</p><p style="padding: 8px 12px; background: rgba(224,179,78,.10); border-left: 3px solid #E0B34E; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>⚠️ Note:</b> Platform type cannot be changed after creation, but other settings can be edited anytime</p><p style="padding: 8px 12px; background: rgba(70,201,140,.08); border-left: 3px solid #46C98C; border-radius: 4px; font-size: 13px;"><b>📌 Next Step:</b> After creation, we\'ll add upstream accounts to this group</p><p style="margin-top: 12px; color: #46C98C; font-weight: 600;">👉 Click "Create" button</p></div>'
      },
      accountManage: {
        title: 'Step 2: Account Pool',
        description:
          '<div class="q-tour"><p>Group ready. Now connect upstream accounts in the <b>Account Pool</b> to power the line.</p><ul><li>Connect upstream AI services (Claude, GPT, Gemini…)</li><li>Multiple accounts per group with load balancing</li><li>OAuth and Session Key onboarding</li></ul><p class="q-tour-cta">Click "Account Pool" in the sidebar →</p></div>'
      },
      createAccount: {
        title: '➕ Add New Account',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Click the button to start adding your first upstream account.</p><p style="padding: 8px 12px; background: rgba(70,201,140,.08); border-left: 3px solid #46C98C; border-radius: 4px; font-size: 13px;"><b>💡 Tip:</b> Recommend using OAuth method - more secure and no manual key extraction needed</p><p style="margin-top: 12px; color: #46C98C; font-weight: 600;">👉 Click "Add Account" button</p></div>'
      },
      accountName: {
      ...
      accountSubmit: {
        title: '✅ Save Account',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Confirm the information and click save.</p><div style="padding: 8px 12px; background: rgba(92,168,255,.08); border-left: 3px solid #5CA8FF; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>📌 OAuth Flow:</b><ul style="margin: 8px 0 0 16px;"><li>Will redirect to service provider page after clicking save</li><li>Complete login and authorization on provider page</li><li>Auto-return after successful authorization</li></ul></div><p style="padding: 8px 12px; background: rgba(70,201,140,.08); border-left: 3px solid #46C98C; border-radius: 4px; font-size: 13px;"><b>📌 Next Step:</b> After adding account, we\'ll create an API key</p><p style="margin-top: 12px; color: #46C98C; font-weight: 600;">👉 Click "Save" button</p></div>'
      },
      finish: {
        title: 'Supply Line is Live',
        description:
    ...
    user: {
      welcome: {
        ...
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the subme AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #46C98C; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
        title: '🔑 API Key Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Manage all your API access keys here.</p><p style="padding: 8px 12px; background: rgba(92,168,255,.08); border-left: 3px solid #5CA8FF; border-radius: 4px; font-size: 13px;"><b>📌 What is an API Key?</b><br/>An API key is your credential for accessing AI services, like a key that allows your application to call AI capabilities.</p><p style="margin-top: 12px; color: #46C98C; font-weight: 600;">👉 Click to enter key page</p></div>'
      },
      createKey: {
        title: '➕ Create New Key',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Click the button to create your first API key.</p><p style="padding: 8px 12px; background: rgba(70,201,140,.08); border-left: 3px solid #46C98C; border-radius: 4px; font-size: 13px;"><b>💡 Tip:</b> Key is only shown once after creation, make sure to copy and save</p><p style="margin-top: 12px; color: #46C98C; font-weight: 600;">👉 Click "Create Key"</p></div>'
      },
      keyName: {
        title: '✏️ Key Name',
      ...
      keySubmit: {
        ...
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Click to confirm and create your API key.</p><div style="padding: 8px 12px; background: #fee2e2; border-left: 3px solid #ef4444; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>⚠️ Important:</b><ul style="margin: 8px 0 0 16px;"><li>Copy the key (sk-xxx) immediately after creation</li><li>Key is only shown once, need to regenerate if lost</li></ul></div><p style="padding: 8px 12px; background: rgba(70,201,140,.08); border-left: 3px solid #46C98C; border-radius: 4px; font-size: 13px;"><b>🚀 How to Use:</b><br/>Configure the key in any OpenAI-compatible client (like ChatBox, OpenCat, etc.) and start using!</p><p style="margin-top: 12px; color: #46C98C; font-weight: 600;">👉 Click "Create" button</p></div>'
      }
    }
  },
