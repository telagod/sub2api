export default {
  ...
  home: {
    ...
    quench: {
      ...
      capabilitiesTitle: '为生产环境而建',
      capabilitiesDesc: '从接入、调度到计费与风控，一条完整的网关链路',
      features: {
        realtimeUsage: '实时用量与告警',
        realtimeUsageDesc: '请求级用量明细、实时 QPS 与错误率监控，异常自动告警。',
        riskControl: '风控与限速',
        riskControlDesc: 'RPM / 并发 / 配额三层限速，IP 白名单与异常行为识别。',
        stickySession: '会话保持',
        stickySessionDesc: '同一会话稳定路由到同一上游账号，上下文连续不漂移。'
      },
      ctaTitle: '准备好接入了吗？',
      ctaDesc: '注册即可获得统一密钥，OpenAI 兼容协议几分钟完成迁移。'
    },
    // 新增：面向用户的价值主张
  ...
  nav: {
    ...
    quench: {
      ...
      settings: '设置',
      announcements: '公告',
      searchPlaceholder: '搜索功能或跳转...',
      openCommandPalette: '打开命令面板',
      commandPalette: '命令面板',
      commandPalettePlaceholder: '搜索页面、功能...',
      noResults: '没有匹配的结果',
    },
  },
  ...
  admin: {
    ...
    groups: {
      ...
      claudeMaxSimulation: {
        ...
        tooltip:
          '启用后，对于没有上游 cache-write 用量的 Claude 模型，系统会确定性地将 Token 映射为少量 input 加 1h cache_creation，同时保持总 Token 数不变。',
        enabled: '已启用（模拟 1h 缓存）',
        disabled: '已禁用',
        hint: '仅调整用量账单日志中的 Token 分类，不持久化每请求的映射状态。'
      },
      supportedScopes: {
        title: '支持的模型系列',
    ...
    settings: {
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 subme 用户登录',
      ...
      agreement: {
        docsHint: '可参考：服务条款、使用政策、支持的国家和地区、服务特定条款。',
        addDoc: '添加文档',
        unnamedDoc: '未命名文档',
        docTitle: '文档名称',
        docTitlePlaceholder: '例如：服务条款',
        docSlug: '路由标识',
    ...
    // ── 新 Quench 页面 i18n key（C 路 P1~P4）──────────────────────────────
    usersQuench: {
      title: '用户',
      desc: '客户域 · 以人为中心，点击行展开用户 360',
      refresh: '刷新',
      createBtn: '+ 新建用户',
      // 筛选栏
      searchPlaceholder: '邮箱 / 用户名 / ID…',
      clearSearch: '清空搜索',
      filterRole: '角色',
      filterStatus: '状态',
      clearFilters: '清空筛选',
      ...
      bulkDeleteConfirm: '确认删除选中的 {n} 个用户？此操作不可撤销。',
      bulkDeleteCancel: '取消',
      bulkDeleteConfirmBtn: '确认删除',
      bulkDeletingProgress: '删除中… ({current}/{total})',
      noEnableTarget: '无可启用用户',
      noDisableTarget: '无可禁用用户',
      bulkEnabledSuccess: '已启用 {n} 个用户',
      bulkDisabledSuccess: '已禁用 {n} 个用户',
      bulkDeletedSuccess: '已删除 {n} 个用户',
      // 表格列标题
      colUser: '用户',
      colRole: '角色',
      colBalance: '余额',
      ...
      // ── 高级筛选字段 ──
      filterFieldRole: '角色',
      filterFieldStatus: '状态',
      filterFieldGroup: '分组',
      filterFieldGroupPlaceholder: '分组名称…',
      filterFieldBalance: '余额',
      filterMin: '最小值',
      filterMax: '最大值',
      filterFieldCreatedAt: '注册时间',
      filterFieldLastActive: '最后活跃',
      filterFieldSubStatus: '订阅状态',
      subStatusActive: '活跃',
    ...
    subscriptionsQuench: {
      ...
      filterGroup: '分组',
      filterExpires: '到期时间',
      filterAutoRenew: '自动续费',
      filterSearch: '搜索',
      searchPlaceholder: '邮箱 / 用户 ID…',
      actionExtend: '续期 / 调整',
      actionResetQuota: '重置配额',
      actionRevoke: '吊销',
      bulkRevoke: '批量吊销',
      noBulkRevokeTarget: '没有可吊销的活跃订阅',
      bulkRevokedSuccess: '已吊销 {n} 条订阅',
      assignTitle: '分配订阅',
      extendTitle: '续期 / 调整订阅',
      revokeTitle: '吊销订阅',
      resetQuotaTitle: '重置使用配额',
      formUser: '用户',
      formGroup: '套餐分组',
      formDays: '有效天数',
      formAdjustDays: '调整天数',
      searchUserPlaceholder: '搜索邮箱或用户 ID…',
      noGroups: '暂无可用订阅分组',
      validityHint: '订阅有效天数（最少 1 天）',
      adjustHint: '正数延长，负数缩短。调整后的到期时间必须在未来。',
      adjustDaysPlaceholder: '如 30 或 -7',
      extendForUser: '调整对象：',
      currentExpiry: '当前到期',
      assign: '分配',
      assigning: '分配中…',
      assignedSuccess: '订阅已分配',
      adjust: '应用',
      adjusting: '应用中…',
      extendedSuccess: '订阅已调整',
      revoke: '吊销',
      revoking: '吊销中…',
      revokedSuccess: '订阅已吊销',
      revokeConfirm: '确认吊销 {user} 的订阅？此操作不可撤销。',
      resetQuota: '重置',
      resetting: '重置中…',
      quotaResetSuccess: '使用配额已重置',
      resetQuotaConfirm: '确认重置 {user} 的所有使用配额（日 / 周 / 月）？',
    },
    ...
    userFormDrawer: {
      ...
      emailLabel: '邮箱',
      passwordLabel: '密码 *',
      passwordEditLabel: '新密码（留空不修改）',
      passwordPlaceholder: '至少 8 位',
      passwordGenTitle: '随机生成',
      usernameLabel: '用户名',
      usernamePlaceholder: '可选',
      balanceLabel: '初始余额',
      concurrencyLabel: '并发上限',
      rpmLabel: 'RPM 限速',
      rpmHint: '（0 = 不限制）',
      notesLabel: '备注',
      notesPlaceholder: '管理员内部备注',
      cancelBtn: '取消',
      saving: '保存中…',
      creating: '创建中…',
      saveChanges: '保存更改',
      createUser: '创建用户',
      validEmailRequired: '邮箱不能为空',
      validPasswordRequired: '密码不能为空',
      validConcurrencyMin: '并发上限至少为 1',
      userUpdated: '用户已更新',
      userCreated: '用户已创建',
      operationFailed: '操作失败',
    },
    ...
    userDetailDrawer: {
      ...
      disableAccount: '禁用账号',
      enableAccount: '启用账号',
      cannotDisableSelf: '无法禁用自己的管理员账号',
    ...
    userTabs: {
      ...
      keyGroup: '组：{name}',
      keyQuota: '配额：',
      keyQuotaUnlimited: '不限',
      keyUsed: '已用：',
      keyCreated: '创建：',
      keyLastUsed: '末用：',
      totalCount: '共 {total} 条',
      totalCountPartial: '共 {total} 条，仅展示前 {shown} 条',
      // orders tab
      noOrders: '暂无订单记录',
      // subscriptions tab
      ...
      chartLoading: '加载中…',
      chartNoData: '暂无数据',
      chartLoadError: '图表数据加载失败',
      infoUserId: '用户 ID',
      infoEmail: '邮箱',
      infoUsername: '用户名',
      infoConcurrency: '并发上限',
      infoRpm: 'RPM 上限',
      infoRpmUnlimited: '不限',
      infoRegistered: '注册时间',
      infoLastActive: '最近活跃',
    ...
    accountsQuench: {
      ...
      filterStatus: '状态',
      filterGroup: '分组',
      filterPrivacyMode: '隐私模式',
      typeApiKey: 'API Key',
      typeOAuth: 'OAuth',
      typeSetupToken: 'Setup Token',
      noAccounts: '暂无账号',
      addAccountBtn: '接入账号',
      searchPlaceholder: '搜索账号名 / email...',
      allPlatforms: '全部平台',
      allStatuses: '全部状态',
      allGroups: '全部分组',
      ungrouped: '未分组',
      ...
      toolsImport: '导入数据',
      toolsExport: '导出数据',
      toolsErrorPassthrough: '错误透传规则',
      toolsTLSProfiles: 'TLS 指纹配置',
      viewMatrix: '健康矩阵',
      viewTable: '表格模式',
      deleteTitle: '删除账号',
      deleteConfirmFmt: '确认删除账号「{name}」？',
      exportTitle: '导出数据',
    ...
    accountTablePanel: {
      ...
      bulkClear: '清除',
      bulkDelete: '批量删除',
      bulkResetStatus: '重置状态',
      bulkRefreshToken: '刷新凭证',
      bulkEnableSchedule: '启用调度',
      bulkDisableSchedule: '禁用调度',
      bulkEdit: '批量编辑',
      colName: '名称',
      colCapacity: '容量',
      colStatus: '状态',
    ...
    dashboardQuench: {
      ...
      kpiOrdersSub: '{n} 笔订单',
      kpiRequests: '今日请求',
      kpiAccumRequests: '累计 {n}',
      kpiNewUsers: '新增用户',
      kpiTotalUsers: '总计 {n}',
      kpiCostToday: '今日消耗',
      kpiCostSub: '成本',
      kpiTokenToday: '今日 Token',
      kpiTokenAccum: '累计 {n}',
      kpiAvgResponse: '平均响应',
      ...
      anomalyRateLimit: '限流',
      anomalyNormal: '正常',
      anomalyTotalAccounts: '共 {n} 个账号',
      anomalyAlerts: '告警事件',
      anomalyFiring: '告警中',
      anomalyResolved: '已解决',
      anomalyNoAlerts: '无未处理告警',
      anomalyKeyActive: '活跃',
      anomalyKeyInactive: '非活跃',
      anomalyTotalKeys: '共 {n} 个密钥',
    },

    pricingDesk: {
      title: 'PayGo 计价台',
      desc: '渠道售价 × 分组倍率 → 用户实际单价矩阵',
      refresh: '刷新',
      simulatorBtn: '价格模拟器',
      loadFailed: '加载失败：',
      noData: '暂无渠道定价数据',
      noDataHint: '请先在渠道定价页配置渠道与分组定价',
      goConfigBtn: '前往渠道定价配置',
      colModel: '模型',
      modelCount: '{n} 个模型',
      tieredPricingTitle: '分档定价',
      tieredColTier: '档位',
      ...
      simGroupLabel: '分组',
      simGroupPlaceholder: '— 请选择分组 —',
      simCacheHit: 'Cache 命中比例',
      simResultTitle: '计算结果',
      simInputCost: 'Input 费用',
      simOutputCost: 'Output 费用',
      simCacheCost: 'Cache 读取费用',
      simTotal: '总计',
      simOfficialTotal: '官方价合计：',
      simCheaper: '便宜 {diff}（{pct}%）',
      simDearer: '贵 {diff}（{pct}%）',
      simNoOfficialRef: '暂无官方参考价，无法对比',
      simSelectHint: '请选择模型与分组后查看计价',
      simInputTokens: 'Input Token 量',
      simOutputTokens: 'Output Token 量',
      simClose: '关闭模拟器',
      syncCatalogBtn: '同步目录',
      syncCatalogTitle: '从 OpenRouter 同步多供应商定价明细',
      syncSuccess: '已同步 {n} 个模型',
      officialStripLabel: '官方',
      officialStripPerM: '/M',
      sourceChipTitle: '点击查看多供应商核对',
    },
    ...
    providerVerify: {
      ...
      colIn: 'Input /M',
      colOut: 'Output /M',
      colCacheRead: 'Cache 读 /M',
      colCacheWrite: 'Cache 写 /M',
      colUptime: '在线率',
      colQuant: '量化',
      noProviders: '暂无供应商数据，可点击右上角同步',
      noSlug: '未指定模型 slug',
      syncing: '正在同步供应商价格…',
      showMore: '展开描述',
      showLess: '收起描述',
      editBtn: '编辑覆盖价',
      editDisabledTip: '价格覆盖功能将在 P3 阶段开放',
      overriddenBadge: '已覆盖',
      overriddenLabel: '已覆盖',
      pinnedBadge: '已指定',
      panelTitle: '编辑价格覆盖',
      modeAuto: '自动最低价',
      modeAutoHint: '删除覆盖，恢复自动',
      modePinned: '指定供应商',
      modeManual: '手动输入',
      modeManualHint: '单位 per-MTok，留空=不覆盖该字段',
      selectProviderPlaceholder: '— 选择供应商 —',
      fieldInput: 'Input',
      fieldOutput: 'Output',
      fieldCacheRead: 'Cache 读',
      fieldCacheWrite: 'Cache 写',
      fieldPlaceholder: '留空',
      noteLabel: '备注（可选）',
      notePlaceholder: '例：谈判价，自 2026-Q3 生效',
      saveBtn: '保存',
      saving: '保存中…',
      restoreBtn: '恢复自动',
      saveSuccess: '覆盖已保存',
    ...
    plansCatalog: {
      title: '套餐目录',
      desc: '运营侧镜像 · 所见即所卖，卡片顺序即售卖页顺序',
      statTotal: '套餐总数',
      statOnSale: '在售中',
      statOffSale: '已下架',
      emptyText: '暂无套餐，点击「新建套餐」开始配置',
      onSale: '在售',
      offSale: '已下架',
      moveUp: '上移',
      moveDown: '下移',
      groupMissingFmt: '分组 #{id} 缺失',
      dailyLimitFmt: '日限 ${v}',
      unlimited: '无限额',
      moreFeaturesFmt: '+{n} 项',
      toggleOnTitle: '点击下架',
    ...
    settingsRegistry: {
      ...
      savingBtn: '保存中…',
      saveBtn: '保存更改',
      fieldPasswordConfigured: '已配置，留空则不修改',
      tabGeneral: '通用',
      tabAgreement: '协议',
      tabFeatures: '功能',
      tabSecurity: '安全',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '欢迎使用 subme 控制台',
        description:
          '<div class="q-tour"><p>subme 把多个上游 AI 订阅汇成一条统一的 API 供给线。控制台按<b>业务域</b>组织：</p><ul><li><b>客户</b> — 用户与邀请返利</li><li><b>商业化</b> — 套餐、订单、卡密与优惠码</li><li><b>供给</b> — 账号池、分组路由、渠道定价</li><li><b>可靠性</b> — 监控、告警与风控</li></ul><p class="q-tour-cta">接下来用 3 分钟完成首次供给配置 →</p></div>',
        nextBtn: '开始配置',
        prevBtn: '跳过'
      },
      domains: {
      ...
      cmdk: {
        title: '命令面板 ⌘K',
        description:
          '<div class="q-tour"><p>任何页面按 <kbd>Ctrl</kbd>+<kbd>K</kbd>（或 ⌘K）唤起命令面板，输入页面名直达。</p><p class="q-tour-cta">这是控制台最快的移动方式，建议养成肌肉记忆。</p></div>'
      },
      groupManage: {
        title: '第一步：分组与路由',
        description:
          '<div class="q-tour"><p><b>分组</b>是供给侧的核心：一个分组 = 一条服务线路。</p><ul><li>每个分组挂多个上游账号，自动调度</li><li>独立计费倍率，可设公开或专属</li></ul><div class="q-tour-tip">示例：建一条「VIP 专线」（高倍率）和一条「免费试用」（低倍率）</div><p class="q-tour-cta">点击左侧「分组与路由」开始 →</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">现在让我们创建第一个分组。</p><p style="padding: 8px 12px; background: rgba(92,168,255,.08); border-left: 3px solid #5CA8FF; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>📝 提示：</b>建议先创建一个测试分组，熟悉流程后再创建正式分组</p><p style="color: #46C98C; font-weight: 600;">👉 点击"创建分组"按钮</p></div>'
      },
      groupName: {
        title: '✏️ 1. 分组名称',
        description:
      ...
      groupSubmit: {
        title: '✅ 保存分组',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">确认信息无误后，点击创建按钮保存分组。</p><p style="padding: 8px 12px; background: rgba(224,179,78,.10); border-left: 3px solid #E0B34E; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>⚠️ 注意：</b>分组创建后，平台类型不可修改，其他信息可以随时编辑</p><p style="padding: 8px 12px; background: rgba(70,201,140,.08); border-left: 3px solid #46C98C; border-radius: 4px; font-size: 13px;"><b>📌 下一步：</b>创建成功后，我们将添加上游账号到这个分组</p><p style="margin-top: 12px; color: #46C98C; font-weight: 600;">👉 点击"创建"按钮</p></div>'
      },
      accountManage: {
        title: '第二步：账号池',
        description:
          '<div class="q-tour"><p>分组已就绪。现在到<b>账号池</b>接入上游账号，让线路真正通电。</p><ul><li>连接上游 AI 服务（Claude、GPT、Gemini 等）</li><li>一个分组挂多个账号，自动负载均衡</li><li>支持 OAuth 与 Session Key 两种接入方式</li></ul><p class="q-tour-cta">点击左侧「账号池」→</p></div>'
      },
      createAccount: {
        title: '➕ 添加新账号',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">点击按钮开始添加您的第一个上游账号。</p><p style="padding: 8px 12px; background: rgba(70,201,140,.08); border-left: 3px solid #46C98C; border-radius: 4px; font-size: 13px;"><b>💡 提示：</b>建议使用 OAuth 方式，更安全且无需手动提取密钥</p><p style="margin-top: 12px; color: #46C98C; font-weight: 600;">👉 点击"添加账号"按钮</p></div>'
      },
      accountName: {
        title: '✏️ 1. 账号名称',
        description:
      ...
      accountSubmit: {
        title: '✅ 保存账号',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">确认信息无误后，点击保存按钮。</p><div style="padding: 8px 12px; background: rgba(92,168,255,.08); border-left: 3px solid #5CA8FF; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>📌 OAuth 授权流程：</b><ul style="margin: 8px 0 0 16px;"><li>点击保存后会跳转到服务商页面</li><li>在服务商页面完成登录授权</li><li>授权成功后自动返回</li></ul></div><p style="padding: 8px 12px; background: rgba(70,201,140,.08); border-left: 3px solid #46C98C; border-radius: 4px; font-size: 13px;"><b>📌 下一步：</b>账号添加成功后，我们将创建 API 密钥</p><p style="margin-top: 12px; color: #46C98C; font-weight: 600;">👉 点击"保存"按钮</p></div>'
      },
      finish: {
        title: '供给线已通电',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 subme',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 subme AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #46C98C; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
        title: '🔑 API 密钥管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">在这里管理您的所有 API 访问密钥。</p><p style="padding: 8px 12px; background: rgba(92,168,255,.08); border-left: 3px solid #5CA8FF; border-radius: 4px; font-size: 13px;"><b>📌 什么是 API 密钥？</b><br/>API 密钥是您访问 AI 服务的凭证，就像一把钥匙，让您的应用能够调用 AI 能力。</p><p style="margin-top: 12px; color: #46C98C; font-weight: 600;">👉 点击进入密钥页面</p></div>'
      },
      createKey: {
        title: '➕ 创建新密钥',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">点击按钮创建您的第一个 API 密钥。</p><p style="padding: 8px 12px; background: rgba(70,201,140,.08); border-left: 3px solid #46C98C; border-radius: 4px; font-size: 13px;"><b>💡 提示：</b>创建后密钥只显示一次，请务必复制保存</p><p style="margin-top: 12px; color: #46C98C; font-weight: 600;">👉 点击"创建密钥"</p></div>'
      },
      keyName: {
        title: '✏️ 密钥名称',
        description:
      ...
      keySubmit: {
        title: '🎉 完成创建',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">点击确认创建您的 API 密钥。</p><div style="padding: 8px 12px; background: #fee2e2; border-left: 3px solid #ef4444; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>⚠️ 重要：</b><ul style="margin: 8px 0 0 16px;"><li>创建后请立即复制密钥（sk-xxx）</li><li>密钥只显示一次，丢失需重新生成</li></ul></div><p style="padding: 8px 12px; background: rgba(70,201,140,.08); border-left: 3px solid #46C98C; border-radius: 4px; font-size: 13px;"><b>🚀 如何使用：</b><br/>将密钥配置到支持 OpenAI 接口的任何客户端（如 ChatBox、OpenCat 等），即可开始使用！</p><p style="margin-top: 12px; color: #46C98C; font-weight: 600;">👉 点击"创建"按钮</p></div>'
      }
    }
  },
